...
Your data contract is the heart of your application. It lives at [`packages/database/src/lib/prisma/contract.prisma`](packages/database/src/lib/prisma/contract.prisma) and describes your models:
...
```typescript
import { db } from './packages/database/src/lib/prisma/db';
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: './packages/database/src/lib/prisma/contract.prisma',
    db: {
...
| File | Purpose |
|---|---|
| [`packages/database/src/lib/prisma/contract.prisma`](packages/database/src/lib/prisma/contract.prisma) | Your data contract — define your models here |
| [`prisma.config.ts`](prisma.config.ts) | CLI configuration |
| [`packages/database/src/lib/prisma/db.ts`](packages/database/src/lib/prisma/db.ts) | Database client — `import { db } from './packages/database/src/lib/prisma/db'` |
| `packages/database/src/lib/prisma/contract.json` | Compiled contract (generated) |
| `packages/database/src/lib/prisma/contract.d.ts` | Contract types (generated) |

### Workflow

1. Edit [`packages/database/src/lib/prisma/contract.prisma`](packages/database/src/lib/prisma/contract.prisma) to add or change models.
